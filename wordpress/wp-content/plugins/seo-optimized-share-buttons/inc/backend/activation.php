...
$apss_share_settings['cache_period'] = '48';
...
$apss_share_settings['apss_email_body'] = 'Hey!, I found this information for you: "%%title%%". Here is the website link: %%permalink%%. Thank you.';
