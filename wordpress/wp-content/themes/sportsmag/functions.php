...
function sportsmag_pro_promo_banner() {
    ...
    <div class="spmag-promo-banner clearfix">
        <div class="banner-image">
            <img src="<?php echo esc_url(get_stylesheet_directory_uri().'/images/upgradeb.jpg'); ?>" />
        </div> 
        ...
        <div class="any-question">
            <?php /* translators: %s : contact link */ echo sprintf( wp_kses(__('Any question!! Click <a href="%s" target="_blank"> here!! </a> for live chat', 'sportsmag'), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url('https://accesspressthemes.com/contact/')); ?>
        </div>

        <div class="view-features">
        <h3><?php esc_html_e('View Features','sportsmag'); ?> <span>+<span></h3>
        
        <div style="display:none" class="view-features-img">
        <img src="<?php echo esc_url(get_stylesheet_directory_uri().'/images/supgrade-mag-pro-features.jpg'); ?>" />
        </div>
        </div>
    </div>
    <?php
