        ...
        <div class="post_image_col clearfix">
            <?php 
                if( has_post_thumbnail() ){
                    ...
                    $sportsmag_big_image_path = wp_get_attachment_image_src( $sportsmag_image_id, 'accesspress-mag-singlepost-default', true );
                    $sportsmag_image_alt = get_post_meta( $sportsmag_image_id, '_wp_attachment_image_alt', true );
             ?>
                    <div class="post-image non-zoomin">
                        <a href="<?php the_permalink();?>"><img src="<?php echo esc_url( $sportsmag_big_image_path[0] );?>" alt="<?php echo esc_attr( $sportsmag_image_alt );?>" /></a>
            ...
            <?php if ( 'post' == get_post_type() ) { ?>
                    <div class="entry-meta <?php if( !has_post_thumbnail() ) { echo 'no-thumb'; }?> clearfix">
                        <div class="post-cat-list"> <?php if( is_author() || is_tag() || is_archive() ){
