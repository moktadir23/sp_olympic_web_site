...
Version 1.2.0
 * Fixed Issue with home page not showing up
 * Added Template Color

Version 1.1.9
 * Made Translation Ready
 * Fixed Archive Image blur issue

Version 1.1.8
 * Fixed Security Issues

Version 1.1.7
 * Slider design issue fixed 


 Version 1.1.6
|* PHP 7 and compability checked 
 * Slider extra options are removed 
 * Youtube section issue fixed
